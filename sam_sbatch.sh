...
# ============================================================================
JOB_NAME="sam_all_data"
MEM="20G"
GPUS="rtx_3090:1"
# =====================================================================ß=======
# INFERRED VALUES - automatically derived from the parameters above
# ============================================================================
SCRIPT_FILE="$(pwd)/BBDM/SAM/<YOUR SCRIPT HERE>.py"
...
cd /home/avinoamd/roni/BBDM/SAM
export PYTHONNOUSERSITE=1
/home/avinoamd/.conda/envs/sam_env/bin/python -u SCRIPT_FILE_PLACEHOLDER
